...
function MovieHome({ filmHome }) {
  ...
  return (
    <Box
      ...
      h={'100vh'}
      bgImage={{
        base: `url(https://image.tmdb.org/t/p/original/${filmHome.poster_path})`,
    ...
    >
      ...
      >
        ...
        >
          ...
          <Flex mt={15}>
            <Link
              key={`details-movie-${filmHome.id}`}
              to={
                filmHome.first_air_date === undefined
                  ? `/details-movie/${filmHome.id}`
                  : `/details-tvshow/${filmHome.id}`
              }
            >
              <Button
                fontSize={{ base: 16, md: 16, lg: 20 }}
